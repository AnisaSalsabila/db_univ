                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" name="telepon" class="form-control" placeholder="Tambah Nomor Telepon">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <textarea name="alamat" id="alamat" cals="2" rows="3" class="form-control" style="resize: none;"></textarea>
                                </div>
                            </div>
                        </div>
                       <div class="form-group">
